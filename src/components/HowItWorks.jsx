...
const steps = [
  {
    ...
    description: 'We discuss your vision, goals, and requirements. No pressure, just conversation.',
    icon: (
  ...
  },
  {
    ...
    description: 'I scope the project and provide a clear quote with timeline. No surprises.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
